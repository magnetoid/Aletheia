    ...
    <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      <div className="flex justify-between items-end mb-8">
        <div>
          ...
          <p className="text-slate-400">Global oversight and configuration.</p>
        </div>
        <div className="flex gap-2">
            <button className="bg-slate-800 hover:bg-slate-700 text-slate-200 px-4 py-2 rounded-lg text-sm font-medium border border-slate-700 flex items-center gap-2 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-slate-800/50 border border-slate-700 p-4 rounded-xl shadow-md shadow-black/10">
          <div className="flex justify-between items-start mb-2">
            <span className="text-slate-400 text-xs uppercase font-bold">System Status</span>
        ...
        >
          <div className="flex justify-between items-start mb-2">
            <span className="text-sky-200 text-xs uppercase font-bold">Data Intelligence</span>
          ...
          <div className="flex items-end gap-2 mb-1">
             ...
             <span className="text-sm text-slate-400 mb-1">active sources</span>
          </div>
          <p className="text-xs text-sky-500 flex items-center gap-1 group-hover:translate-x-1 transition-transform">
            Manage Sources <Settings size={10} />
          </p>
        </div>

        <div className="bg-slate-800/50 border border-slate-700 p-4 rounded-xl shadow-md shadow-black/10">
          <div className="flex justify-between items-start mb-2">
            <span className="text-slate-400 text-xs uppercase font-bold">API Quota</span>
        ...
        <div className="bg-slate-800/50 border border-slate-700 p-4 rounded-xl shadow-md shadow-black/10">
          <div className="flex justify-between items-start mb-2">
            <span className="text-slate-400 text-xs uppercase font-bold">Threats Flags</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-slate-900/50 border border-slate-800 rounded-xl overflow-hidden shadow-xl shadow-black/20 backdrop-blur-sm">
          <div className="p-4 border-b border-slate-800 flex justify-between items-center bg-slate-950/30">
            <h3 className="font-bold text-white flex items-center gap-2">
              <Users size={18} className="text-slate-400"/> User Management
            </h3>
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-xl overflow-hidden shadow-xl shadow-black/20 backdrop-blur-sm">
           <div className="p-4 border-b border-slate-800 flex justify-between items-center bg-slate-950/30">
            <h3 className="font-bold text-white flex items-center gap-2">
              <Globe size={18} className="text-slate-400"/> Live Activity
            </h3>
          </div>
